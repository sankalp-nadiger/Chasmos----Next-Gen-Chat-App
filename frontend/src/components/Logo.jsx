...
const Logo = ({ size = 'md', showText = true, textClassName = '', containerClassName = '' }) => {
  // Size configurations
  const sizes = {
    sm: {
      container: 'w-8 h-8',
  ...
  return (
    <>
      <div className={`${sizeConfig.container} rounded-full bg-blue-600 flex items-center justify-center ${containerClassName}`}>
        <svg
          width={sizeConfig.svg.width}
          height={sizeConfig.svg.height}
          viewBox="0 0 24 24"
          fill="none"
